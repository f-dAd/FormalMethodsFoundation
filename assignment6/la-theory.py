...
if res == sat:
    ...
    print(res)
# raise ("exercise 2: please fill in the missing code.")
...
x, y = Reals('x, y')
cons = [x + y == 8, x - y == 1]
# raise ("exercise 4: please fill in the missing code.")
res, model = check_cons(cons)
print("result for problem 4: domain R")
print_model(res, model)
x, y = Ints('x y')
cons = [x + y == 8, x - y == 1]
res, model = check_cons(cons)
print("result for problem 4: domain Z")
print_model(res, model)
print("-----------------------------------")
#########################################
...
def check_zero_la(l):
    ...
    # raise ("exercise 6: please fill in the missing code.")
...
#   x*x + y*y < 0
# raise ("exercise 7: please fill in the missing code.")
print("-----------------------------------")
...
x, p, q = Ints('x p q')
# raise ("exercise 8: please fill in the missing code.")
res, model = check_cons([x * q == p, x == q, p == 2])
if res == sat:
    print(model)
else:
    print(res)
