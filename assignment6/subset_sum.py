...
def subset_sum_la(target_set: list):
    ...
    for i, flag in enumerate(flags):
        exp.append(flag * target_set[i])
    cons_exp = [sum(exp) == 0]
    solver.add(cons_exp)
    # raise ("exercise 9: please fill in the missing code.")
...
if __name__ == '__main__':
    ...
    # 20
    # time used in DP: 0.363028ss
    # time used in LA: 0.034907s
    # time used in LA optimized: 0.010971s
    # 200
    # time used in LA: 0.359003s
    # time used in LA optimized: 0.034907s

    print("The problems of 10:")
    print("la_opt 性能最优\n"
          "la 性能居中\n"
          "dp 性能最差")
    # raise ("exercise 10: please fill in the missing code.")
